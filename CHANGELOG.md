...
## [3.1.5](https://github.com/rancher/terraform-rancher2-aws/compare/v3.1.4...v3.1.5) (2026-09-22)
...
* add long-lived plans and clean up legacy files ([#189](https://github.com/rancher/terraform-rancher2-aws/issues/189)) ([2e2ad36](https://github.com/rancher/terraform-rancher2-aws/commit/2e2ad36e87bee756fd8f3d08a0defb420c8111d3))
* add operational developer helper scripts and tools ([#188](https://github.com/rancher/terraform-rancher2-aws/issues/188)) ([cdf9ccf](https://github.com/rancher/terraform-rancher2-aws/commit/cdf9ccf2d9deab9d73eaf4b1d526c4400af42734))
...
* bump actions/checkout from 7.0.0 to 7.0.1 ([#183](https://github.com/rancher/terraform-rancher2-aws/issues/183)) ([dc9870f](https://github.com/rancher/terraform-rancher2-aws/commit/dc9870f150e3d696346f7edc2d4585314c127b09))
...
* bump aws-actions/configure-aws-credentials from 6.2.2 to 6.2.3 ([#181](https://github.com/rancher/terraform-rancher2-aws/issues/181)) ([88be7c2](https://github.com/rancher/terraform-rancher2-aws/commit/88be7c20d9fe00ed7e195718c7435afcb75a11b3))
* bump aws-actions/configure-aws-credentials from 6.2.3 to 6.2.4 ([#194](https://github.com/rancher/terraform-rancher2-aws/issues/194)) ([cc238fa](https://github.com/rancher/terraform-rancher2-aws/commit/cc238fa06537cd9ace47dc2161bc98ac658ac211))
...
* bump integrations/github from 6.8.0 to 6.13.0 in /modules/cluster/node_template ([#182](https://github.com/rancher/terraform-rancher2-aws/issues/182)) ([63c5aee](https://github.com/rancher/terraform-rancher2-aws/commit/63c5aeee1ef588f74351580e20c86018cdb434d0))
* bump rancher-eio/read-vault-secrets ([#190](https://github.com/rancher/terraform-rancher2-aws/issues/190)) ([bc13cd5](https://github.com/rancher/terraform-rancher2-aws/commit/bc13cd5da69ef1cea83e9878028efc7d62ba712c))
* configure core agentic guidelines, workflows, and rules ([#186](https://github.com/rancher/terraform-rancher2-aws/issues/186)) ([9c20165](https://github.com/rancher/terraform-rancher2-aws/commit/9c201653be1e5c65978e4b8a83ad6e796527638a))
* implement execution hooks and planning security ([#187](https://github.com/rancher/terraform-rancher2-aws/issues/187)) ([44a771c](https://github.com/rancher/terraform-rancher2-aws/commit/44a771c8a2452160916cd846cad2fdf6d7b47f1a))
...
* provide a dedicated ci environment package ([#200](https://github.com/rancher/terraform-rancher2-aws/issues/200)) ([04965ca](https://github.com/rancher/terraform-rancher2-aws/commit/04965cafabc05b029ef49f5d0b9c8d7c0e81be34))
* reduce parallelism and Go max processors to prevent CPU pinning ([#184](https://github.com/rancher/terraform-rancher2-aws/issues/184)) ([5794b89](https://github.com/rancher/terraform-rancher2-aws/commit/5794b89fc4dbc1740cabcbbc0385a848d6221a37))
...
* test in a matrix ([#199](https://github.com/rancher/terraform-rancher2-aws/issues/199)) ([5dea169](https://github.com/rancher/terraform-rancher2-aws/commit/5dea169d86405c3412efca6643ebaec568bab907))
...
* update development environment nix configurations ([#185](https://github.com/rancher/terraform-rancher2-aws/issues/185)) ([0e12e90](https://github.com/rancher/terraform-rancher2-aws/commit/0e12e90f24175e618c414ce36da96bee38882f24))
* update modules and actions and adjust Rancher version ([#198](https://github.com/rancher/terraform-rancher2-aws/issues/198)) ([f8208d3](https://github.com/rancher/terraform-rancher2-aws/commit/f8208d3e49f468e18429c20e93970b5de8fde357))
